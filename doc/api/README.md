...
可通过简单而强大的API自动化管理GitLab。可该链接[`/lib/api`](https://gitlab.com/gitlab-org/gitlab-ce/tree/master/lib/api)找到所有的API定义。

## 资源

可从以下链接找到各种相关的API资源的文档：

- [奖励表情](award_emoji.md)
- [分支](branches.md)
- [广播消息](broadcast_messages.md)
- [构建](builds.md)
- [建立触发器](build_triggers.md)
- [建立变量](build_variables.md)
- [提交](commits.md)
- [发布](deployments.md)
- [发布密钥](deploy_keys.md)
- [Gitignores模板](templates/gitignores.md)
- [CI配置模板](templates/gitlab_ci_ymls.md)
- [群组](groups.md)
- [群组的访问请求](access_requests.md)
- [群组成员](members.md)
- [问题](issues.md)
- [密钥](keys.md)
- [标签](labels.md)
- [合并请求](merge_requests.md)
- [里程碑](milestones.md)
- [开源许可证模板](templates/licenses.md)
- [命名空间](namespaces.md)
- [注释](notes.md) (comments)
- [通知设置](notification_settings.md)
- [流水线](pipelines.md)
- [项目](projects.md) including setting Webhooks
- [项目的访问请求](access_requests.md)
- [项目成员](members.md)
- [项目的代码片段](project_snippets.md)
- [版本库](repositories.md)
- [版本库文件](repository_files.md)
- [Runners](runners.md)
- [服务](services.md)
- [会话](session.md)
- [设置](settings.md)
- [Sidekiq度量](sidekiq_metrics.md)
...
所有的API访问请求认证都需要通过会话或令牌。有三种令牌：私有令牌，OAuth2令牌，和个人访问令牌。

如果认证信息为无效或省略，则会返回状态码为`401`的异常消息：
...
你需要通过字符串或头名来获取一个私有令牌（`private_token`）参数。如果使用头名，头名必须是`PRIVATE-TOKEN`（大写，且使用破折号代替下划线）。你可以在你的账户页面查询或重置你的私有令牌（`/个人资料设置/账户`）。
